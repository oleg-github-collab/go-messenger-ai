...
(function() {
    ...
    const translations = {
        uk: {
            // Login page
            'login.title': 'Вхід - Kaminskyi Messenger',
            'login.heading': 'Kaminskyi Messenger',
            'login.subtitle': 'Увійдіть, щоб продовжити',
            'login.username': 'Ім\'я користувача',
            'login.usernamePlaceholder': 'Введіть ваше ім\'я',
        ...
        en: {
            // Login page
            'login.title': 'Login - Kaminskyi Messenger',
            'login.heading': 'Kaminskyi Messenger',
